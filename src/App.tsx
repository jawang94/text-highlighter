...
//   { startOffset: 4, endOffset: 10, color: '#C2E6FD', priority: 2 },
//   { startOffset: 4, endOffset: 24, color: '#E5F39E', priority: 3 },
...
Note:
  1. You CAN end on a whitespace due to the way whitespaces are handled (appended after each word).
*/
